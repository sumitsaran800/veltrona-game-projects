			...
			if($shonusign == $signature){
				...
				if($data_auth['status'] === 'Success') {
					...
					if($sesnum == 1){																				
						...
						font-weight: bolder;">Company</span>(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to<a href="https://aladdinngame.xyz" 
						target="_blank">Aladdinn Game</a>.</font></p></li><li style="box-sizing: inherit; background-repeat: no-repeat; padding: 0px; margin: 0px;"><font color="#ffffff" 
						...
						refers to<a href="https://aladdinngame.xyz" target="_blank">Aladdinn Game</a>, accessible from<a href="https://aladdinngame.xyz" 
						target="_blank">Aladdinn Game</a></font></li><li style="box-sizing: inherit; background-repeat: no-repeat; padding: 0px; margin: 0px;">
