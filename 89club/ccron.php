...
$tasks = [
    [
        'url' => 'https://89club.veltronaerp.in/niyamitakelasa_aidudi.php',
        'interval' => '* * * * *', // Every minute
    ],
    [
        'url' => 'https://89club.veltronaerp.in/niyamitakelasa_aidudi_funf.php',
        'interval' => '*/5 * * * *', // Every 5 minutes
    ],
    [
        'url' => 'https://89club.veltronaerp.in/niyamitakelasa_funf.php',
        'interval' => '*/5 * * * *', // Every 5 minutes
    ],
    [
        'url' => 'https://89club.veltronaerp.in/niyamitakelasa_kemuru_drei.php',
        'interval' => '*/3 * * * *', // Every 3 minutes
    ],
    [
        'url' => 'https://89club.veltronaerp.in/niyamitakelasa_kemuru_funf.php',
        'interval' => '*/5 * * * *', // Every 5 minutes
    ],
    [
        'url' => 'https://89club.veltronaerp.in/niyamitakelasa_kemuru_zehn.php',
        'interval' => '* * * * *', // Every 10 minutes
    ], 
    [
        'url' => 'https://89club.veltronaerp.in/niyamitakelasa_aidudi_drei.php',
        'interval' => '*/3 * * * *', // Every 3 minutes
    ],
    [
        'url' => 'https://89club.veltronaerp.in/niyamitakelasa.php',
        'interval' => '* * * * *', // Every minute
    ],
    [
        'url' => 'https://89club.veltronaerp.in/niyamitakelasa_kemuru.php',
        'interval' => '*/5 * * * *', // Every 5 minutes
    ],
    [
