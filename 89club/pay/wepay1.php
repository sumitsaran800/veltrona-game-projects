...
if (isset($_GET['tyid']) && isset($_GET['amount']) && isset($_GET['uid']) && isset($_GET['sign']) && isset($_GET['urlInfo'])) {
    ...
    if($myurl){
        ...
        // Set up parameters
        $notify_url = "https://89club.veltronaerp.in/pay/lgwebhook.php";
...
if ($apiData) {
    ...
    $app_id = $config['app_id'];
        ...
        $params = [
            ...
            'trade_type' => 'INRUPI',
            'order_sn' => $serial,
            'return_url' => 'https://89club.veltronaerp.in',
        ];
        ...
        if (curl_errno($ch)) {
            ...
            if ($responseData && $responseData['status'] == 1 && isset($responseData['data']['pay_url'])) {
                ...
                VALUES('1','$uid', '$amount', '$srl', '$payName','$ref_num', '$email', '$upi', '$createdate', '1005', '2', '0')");
