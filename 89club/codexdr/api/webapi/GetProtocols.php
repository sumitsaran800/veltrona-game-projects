			...
			if($shonusign == $signature){
				...
				if($data_auth['status'] === 'Success') {
					...
					if($sesnum == 1){																				
						...
						font-weight: bolder;">Company</span>(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to<a href="http://127.0.0.1:8001" 
						...
						refers to<a href="http://127.0.0.1:8001" target="_blank">91 𝐂𝐋𝐔𝐁 Game</a>, accessible from<a href="http://127.0.0.1:8001" 
