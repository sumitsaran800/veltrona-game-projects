			...
			if($shonusign == $signature){
				...
				if($data_auth['status'] === 'Success') {
					...
					if($sesnum == 1){
                        ...
                        $data["list"][0]["bannerUrl"] = "https://89club.veltronaerp.in/Banners/1.png";
                        ...
                        $data["list"][1]["bannerUrl"] = "https://89club.veltronaerp.in/Banners/2.png";
                        ...
                        $data["list"][2]["bannerUrl"] = "https://89club.veltronaerp.in/Banners/6.png";
                        ...
                        $data["list"][3]["bannerUrl"] = "https://89club.veltronaerp.in/Banners/4.png";
                        ...
                        $data["list"][4]["bannerUrl"] = "https://89club.veltronaerp.in/Banners/5.png";
