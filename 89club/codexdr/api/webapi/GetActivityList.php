			...
			if($shonusign == $signature){
				...
				if($data_auth['status'] === 'Success') {
					...
					if($sesnum == 1){
                        ...
                        $data["list"][0]["bannerUrl"] = "http://127.0.0.1:8001/Banners/1.png";
                        ...
                        $data["list"][1]["bannerUrl"] = "http://127.0.0.1:8001/Banners/2.png";
                        ...
                        $data["list"][2]["bannerUrl"] = "http://127.0.0.1:8001/Banners/6.png";
                        ...
                        $data["list"][3]["bannerUrl"] = "http://127.0.0.1:8001/Banners/4.png";
                        ...
                        $data["list"][4]["bannerUrl"] = "http://127.0.0.1:8001/Banners/5.png";
