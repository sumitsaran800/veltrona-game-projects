    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <h4 class="font-weight-bold text-dark">Withdrwal Problem</h4>
          <div class="row">
            <div class="col-sm-12">
              <div class="table-responsive">
                <table id="yourTable" class="table table-striped">
                  ...
                  <tbody>
                    <?php
                    $sql = "SELECT id, userid, deposit_order_no,image_upload,file_upload, order_amount, text_content, remarks FROM your_table WHERE prob = 'Withdrawal problem' AND status = 2";
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td><a href='https://89club.veltronaerp.in/uploads/" . $row["file_upload"] . "'>" . $row["file_upload"] . "</a></td>";
