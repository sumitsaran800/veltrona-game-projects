...
<?php
	...
	if($actiontype=='getdata'){
		$Query=mysqli_query($conn,"select sankhye, banna, sthiti, shonu from `hastacalita_phalitansa_drei`"); 
...
?>
<?php
		$sqlA = mysqli_query($conn,"Update `hastacalita_phalitansa_drei` set sthiti = '0'");			
