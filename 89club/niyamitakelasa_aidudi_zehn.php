...
if (!defined("SECURITY_PASS")) { die(); }
	...
	$prathama = date('Ymd')."10204".sprintf("%04d",1);
	$sesa = $lastperiodid=date('Ymd')."10204".sprintf("%04d",144);
	...
	$bartamankalakrama = $ajitarika ."10204". sprintf("%04d", $bartamankalasankhya);
