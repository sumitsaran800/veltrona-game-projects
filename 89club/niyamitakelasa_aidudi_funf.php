...
if (!defined("SECURITY_PASS")) { die(); }
	...
	$prathama = date('Ymd')."10203".sprintf("%04d",1);
	$sesa = $lastperiodid=date('Ymd')."10203".sprintf("%04d",288);
	...
	$bartamankalakrama = $ajitarika ."10203". sprintf("%04d", $bartamankalasankhya);
