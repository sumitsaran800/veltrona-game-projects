...
if (!defined("SECURITY_PASS")) { die(); }
	...
	$prathama = date('Ymd')."10201".sprintf("%04d",1);
	$sesa = $lastperiodid=date('Ymd')."10201".sprintf("%04d",1440);
	...
	$bartamankalakrama = $ajitarika ."10201". sprintf("%04d", $bartamankalasankhya);
