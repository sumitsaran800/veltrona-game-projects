...
$dbusername = "a91ga644174_maxclub1"; 
$dbpassword = "A91ga644174_maxclub1";
$dbname     = "a91ga644174_maxclub1";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Generate secret_key (random pattern)
    $secret_key = "PT" . strtoupper(substr(uniqid(), -8)) . "N";

    // Insert into table (all default = 1)
    $sql = "INSERT INTO nirvahaka_shonu 
    (hesaru, nirvahaka_hesaru, guptapada, sthiti, secret_key, 
    dashboard, wingomanager, k3manager, 5dmanager, finance, support, 
    managegame, manageagent) 
    VALUES 
    ('$new_username', '$new_username', '$hashed_password', 1, '$secret_key',
     1, 1, 1, 1, 1, 1, 1, 1)";
