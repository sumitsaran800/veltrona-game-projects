...
<?php
	...
	$samasye = "SELECT atadaaidi FROM `gelluonduhogu_aidudi` ORDER BY kramasankhye DESC LIMIT 1";
...
<body>
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-sm-12 mb-4 mb-xl-0">
              <h4 class="font-weight-bold text-dark">5D 1 Min</h4>
            </div>
          </div> 
		  <div class="row">
		  ...
		  <div class="row">
            <div class="col-sm-12">
			  ...
			  <form action="itticina_geluvu_aidudi" id="pre" method="POST">
  ...
  <script>	
	...
	function wingoonetotal()
	{
		$.ajax({
		type: "Post",
		url: "ottu_gellaluhogiondu_aidudi.php",
	...
	var table = $('#example2').DataTable({
		"processing": true,
		"serverSide": true,
		"ajax": "detavannunirvahisi_aidudi.php",
		"paging": true,
		"lengthChange": false,
		"searching": true,
		"ordering": false,
	...
	function resetman(){		
		$.ajax({
			type: "Post",
			data:"stat=" + "1",
			url: "maruhondisi_gellalu_aidudi.php",
			success: function (html) {
			 console.log(html);
			  return false;
			  },
