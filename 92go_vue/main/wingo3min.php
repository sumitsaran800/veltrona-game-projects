...
<?php
	...
	$samasye = "SELECT atadaaidi FROM `gelluonduhogu_drei` ORDER BY kramasankhye DESC LIMIT 1";
	$samasyephalitansa = $conn->query($samasye);
	$samasyephalitansa_dhadi = mysqli_fetch_assoc($samasyephalitansa);
	
	$munde = mysqli_query($conn,"SELECT sankhye FROM `hastacalita_phalitansa_drei` WHERE `sthiti`='1'");
...
<body>
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-sm-12 mb-4 mb-xl-0">
              <h4 class="font-weight-bold text-dark">WinGo 3 Min</h4>
            </div>
          </div> 
		  <div class="row">
		  ...
		  <div class="row">
            <div class="col-sm-12">
			  ...
			  <form action="itticina_geluvu_drei" id="pre" method="POST">
		  ...
		  <div class="row">
            <div class="col-sm-12"> 
			  ...
			  <table id="example1" class="table table-bordered table-striped">
				...
				<tbody id="betdetail">
					<?php 
						$samasye = mysqli_query($conn,"select * from `hastacalita_phalitansa_drei`");
						$i=0;
  ...
  <script>
	...
	function wingoonetotal()
	{
		$.ajax({
		type: "Post",
		url: "ottu_gellaluhogiondu_drei.php",
	...
	function getbettingdata(actiontype)
	{
		var periodid=$("#periodid").val();
			...
			url: "mottavannupadeyiri_drei.php",
			success: function (html) {
	...
	var table = $('#example2').DataTable({
		"processing": true,
		"serverSide": true,
		"ajax": "detavannunirvahisi_drei.php",
		"paging": true,
		"lengthChange": false,
		"searching": true,
		"ordering": false,
	...
	function resetman(){		
		$.ajax({
			type: "Post",
			data:"stat=" + "1",
			url: "maruhondisi_gellalu_drei.php",
			success: function (html) {
			 console.log(html);
			  return false;
			  },
