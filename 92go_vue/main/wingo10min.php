...
<body>
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-sm-12 mb-4 mb-xl-0">
              <h4 class="font-weight-bold text-dark">WinGo 30Sec</h4>
            </div>
          </div> 
		  <div class="row">
  ...
  <script>
    ...
    var distance = 30 - serverTime % 30; // Change from 600 seconds to 30 seconds
    var interval = setInterval(function () {
        ...
        document.getElementById("demo").innerHTML = 
            "<span class='timer'>0" + Math.floor(minutes) + "</span>" +
            "<span>:</span>" +
            "<span class='timer'>" + seconds + "</span>";

        if (distance === 5) { // Arbitrary example action 5 seconds before reset
            resetman();
        }
