...
<?php
	...
	if(isset($_POST['newupi'])){
		...
		$sql_q = "UPDATE crashgamerecordtwo SET crashpoint='".$upiid."' WHERE id='1'";
		$chk = mysqli_query($conn, $sql_q);
		if($chk){
			echo '<script type="text/JavaScript"> alert("Jet Max Value Updated"); </script>';
		}else {echo '<script type="text/JavaScript"> alert("Jet Max Value Update Failed"); </script>';}
	}
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-sm-12 mb-4 mb-xl-0">
              <h4 class="font-weight-bold text-dark">Update Jet Max Value</h4>
            </div>
          </div> 
		  <div class="row">
			...
			<form action="#" id="upiform" method="post" autocomplete="off">
				<div class="d-flex align-items-center">	
					<input name="newupi" type="text" placeholder="Enter Jet Max Value" class="flex-grow-1 cool-input" style="height: 40px;" />
				</div>
