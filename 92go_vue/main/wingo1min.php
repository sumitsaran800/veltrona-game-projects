...
<?php
	...
	$munde = mysqli_query($conn,"SELECT sankhye FROM `hastacalita_phalitansa` WHERE `sthiti`='1'");
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            <div class="col-sm-12 mb-4 mb-xl-0">
              <h4 class="font-weight-bold text-dark">WinGo 1 Min</h4>
            </div>
          </div> 
		  <div class="row">
		  ...
		  <div class="row">
            <div class="col-sm-12">
			  ...
			  <form action="itticina_geluvu" id="pre" method="POST">
		  ...
		  <div class="row">
            <div class="col-sm-12"> 
			  ...
			  <table id="example1" class="table table-bordered table-striped">
				...
				<tbody id="betdetail">
					<?php 
						$samasye = mysqli_query($conn,"select * from `hastacalita_phalitansa`");
						$i=0;
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © AbCoders 2024</span>
          </div>
        </footer>
      </div>
    </div>
