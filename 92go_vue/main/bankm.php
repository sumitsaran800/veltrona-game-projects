    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <h4 class="font-weight-bold text-dark">Change bank name</h4>
          <div class="row">
            <div class="col-sm-12">
              <div class="table-responsive">
                <table id="yourTable" class="table table-striped">
                  ...
                  <tbody>
                    <?php
                    $sql = "SELECT id, userid, deposit_order_no,bank_account_number,ifsc, order_amount, text_content, remarks FROM your_table WHERE prob = 'Change bank name' AND status = 2";
