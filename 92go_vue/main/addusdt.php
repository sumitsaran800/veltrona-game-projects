        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-sm-12 mb-4 mb-xl-0">
              <h4 class="font-weight-bold text-dark">Add USDT</h4>
            </div>
          </div> 
		  <div class="row">
			<form action="#" id="upiform" method="post" autocomplete="off">
				<div class="d-flex align-items-center">	
					<input name="newupi" type="text" placeholder="Add an USDT ID" class="flex-grow-1 cool-input" style="height: 40px;" />
				</div>
		  ...
		  <div class="row">
            <?php
				$sel_upi = "SELECT * FROM deyyamrici WHERE sthiti='0' OR sthiti='1'";
