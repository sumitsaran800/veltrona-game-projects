...
<?php
	...
	$samasye = "SELECT atadaaidi FROM `gelluonduhogu_kemuru_drei` ORDER BY kramasankhye DESC LIMIT 1";
	$samasyephalitansa = $conn->query($samasye);
	$samasyephalitansa_dhadi = mysqli_fetch_assoc($samasyephalitansa);
	
	$munde = mysqli_query($conn,"SELECT sankhye FROM `hastacalita_phalitansa_kemeru_drei` WHERE `sthiti`='1'");
...
<body>
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-sm-12 mb-4 mb-xl-0">
              <h4 class="font-weight-bold text-dark">K3 3 Min</h4>
            </div>
          </div> 
		  <div class="row">
		  ...
		  <div class="row">
            <div class="col-sm-12">
			  ...
			  <form action="itticina_geluvu_kemuru_drei" id="pre" method="POST">
  ...
  <script>	
	...
	function wingoonetotal()
	{
		$.ajax({
		type: "Post",
		url: "ottu_gellaluhogiondu_kemuru_drei.php",
	...
	var table = $('#example2').DataTable({
		"processing": true,
		"serverSide": true,
		"ajax": "detavannunirvahisi_kemuru_drei.php",
		"paging": true,
		"lengthChange": false,
		"searching": true,
		"ordering": false,
	...
	function resetman(){		
		$.ajax({
			type: "Post",
			data:"stat=" + "1",
			url: "maruhondisi_gellalu_kemuru_drei.php",
			success: function (html) {
			 console.log(html);
			  return false;
			  },
	...
	function startTimer(serverTime) {
		var distance = 180 - serverTime % 180;
