	...
	if ($_SERVER['REQUEST_METHOD'] != 'GET') {		
		if (isset($shonupost['language']) && isset($shonupost['random']) && isset($shonupost['signature']) && isset($shonupost['timestamp'])) {
			...
			if($shonusign == $signature){
				...
				$data['projectName'] = "Hitwin";
				$data['projectLogo'] = 'https://i.postimg.cc/vmwV5cfq/logo.png';
				$data['languages'] = 'en|hd';
				$data['webIco'] = 'https://i.postimg.cc/vmwV5cfq/logo.png';
				$data['headLogo'] = 'https://i.postimg.cc/vmwV5cfq/logo.png';
				$data['dollarSign'] = '₹';
				$data['upperOrLower'] = '0';
				...
				$data['areaPhoneLenList'][0]['len'] = '9-10';
			
				$data['registerSms'] = '0';
				$data['isOpenLoginChangeLanguage'] = '1';
				$data['rewardValidityTime'] = 30;
				$data['electronicWinRateExternalLink'] = '';
				$data['electronicWinRateImgUrl'] = 'https://ossimg.yuk87k786d.com/sikkim';
