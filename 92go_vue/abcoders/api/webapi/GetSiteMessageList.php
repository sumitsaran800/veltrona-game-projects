	...
	if ($_SERVER['REQUEST_METHOD'] != 'GET') {		
		if (isset($shonupost['language']) && isset($shonupost['pageNo']) && isset($shonupost['pageSize']) && isset($shonupost['random']) && isset($shonupost['signature']) && isset($shonupost['timestamp'])) {
			...
			if($shonusign == $signature){
				$list[0]['title'] = 'About Withdrawal - Bet96 Notify';
				...
				$list[1]['title'] = 'More Games - Bet96  Notify';
				$list[1]['siteMessage'] = '"Coming Soon! 🎉
Something exciting is on the way! Keep an eye out for updates—you won’t want to miss this!"';
