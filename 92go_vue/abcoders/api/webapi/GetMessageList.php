					...
					if($sesnum == 1){
						...
						while ($notificationRow = $notificationResult->fetch_assoc()) {
							$data['list'][] = [
								...
								'messages' => "Your account was just logged in on {$notificationRow['created_at']}. If you have any questions, please feel free to contact online customer service! I wish you happy gaming and lots of Rs profits!",
							];
						}
