...
function Z(e = {}, i = {}) {
    Object.keys(i).forEach(t => {
        typeof e[t] > "u" ? e[t] = i[t] : se(i[t]) && se(e[t]) && Object.keys(i[t]).length > 0 && Z(e[t], i[t])
    })
}
const me = {
    body: {},
...
function He(e, i) {
    ...
    for (let t = 0; t < this.length; t += 1)
        if (arguments.length === 2) this[t].setAttribute(e, i);
            ...
            for (const n in e) this[t][n] = e[n], this[t].setAttribute(n, e[n]);
    return this
}
    ...
    if (arguments.length === 1)
        if (typeof e == "string") {
            ...
            for (n = 0; n < this.length; n += 1)
                for (const s in e) this[n].style[s] = e[s];
            return this
        }
...
function dt(...e) {
    ...
    for (let n = 0; n < e.length; n += 1) {
        ...
        for (let s = 0; s < this.length; s += 1)
            ...
            for (let r = 0; r < i.length; r += 1) this[s].appendChild(i[r]);
...
function xt(e, i = "x") {
    ...
    let n, s, r;
    const a = Tt(e);
    return t.WebKitCSSMatrix ? (s = a.transform || a.webkitTransform, s.split(",").length > 6 && (s = s.split(", ").map(d => d.replace(",", ".")).join(", ")), r = new t.WebKitCSSMatrix(s === "none" ? "" : s)) : (r = a.MozTransform || a.OTransform || a.MsTransform || a.msTransform || a.transform || a.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,"), n = r.toString().split(",")), i === "x" && (t.WebKitCSSMatrix ? s = r.m41 : n.length === 16 ? s = parseFloat(n[12]) : s = parseFloat(n[4])), i === "y" && (t.WebKitCSSMatrix ? s = r.m42 : n.length === 16 ? s = parseFloat(n[13]) : s = parseFloat(n[5])), s || 0
}
...
function ve({
    ...
    const l = i > s ? "next" : "prev",
        ...
        u = () => {
            ...
            let p = s + c * (i - s);
            if (o(p, i) && (p = i), e.wrapperEl.scrollTo({
                    [t]: p
                }), o(p, i)) {
...
const It = {
    ...
    off(e, i) {
        ...
        return !t.eventsListeners || t.destroyed || !t.eventsListeners || e.split(" ").forEach(n => {
            typeof i > "u" ? t.eventsListeners[n] = [] : t.eventsListeners[n] && t.eventsListeners[n].forEach((s, r) => {
    ...
    emit(...e) {
        ...
        let t, n, s;
        return typeof e[0] == "string" || Array.isArray(e[0]) ? (t = e[0], n = e.slice(1, e.length), s = i) : (t = e[0].events, n = e[0].data, s = e[0].context || i), n.unshift(s), (Array.isArray(t) ? t : t.split(" ")).forEach(a => {
...
function At() {
    ...
    typeof v == "string" && v.indexOf("%") >= 0 && (v = parseFloat(v.replace("%", "")) / 100 * r), e.virtualSize = -v, a ? u.css({
        marginLeft: "",
        marginBottom: "",
        marginTop: ""
    }) : u.css({
        ...
        marginBottom: "",
        marginTop: ""
    }), n.centeredSlides && n.cssMode && (F(e.wrapperEl, "--swiper-centered-offset-before", ""), F(e.wrapperEl, "--swiper-centered-offset-after", ""));
    ...
    if (e.virtualSize = Math.max(e.virtualSize, r) + g, a && d && (n.effect === "slide" || n.effect === "coverflow") && s.css({
            width: `${e.virtualSize+n.spaceBetween}px`
        }), n.setWrapperSize && s.css({
            [i("width")]: `${e.virtualSize+n.spaceBetween}px`
        }), O && e.grid.updateWrapperSize(x, c, i), !n.centeredSlides) {
        const b = [];
    ...
    if (c.length === 0 && (c = [0]), n.spaceBetween !== 0) {
        ...
        u.filter((E, M) => n.cssMode ? M !== u.length - 1 : !0).css({
            [b]: `${v}px`
        })
    }
...
function _t(e) {
    ...
    if (i.params.slidesPerView !== "auto" && i.params.slidesPerView > 1)
        if (i.params.centeredSlides)(i.visibleSlides || h([])).each(d => {
            t.push(d)
        });
        else
...
function Nt(e) {
    ...
    const d = r,
        l = a;
    n === 0 ? (s = 0, r = !0, a = !0) : (s = (e - i.minTranslate()) / n, r = s <= 0, a = s >= 1), Object.assign(i, {
        progress: s,
        isBeginning: r,
        isEnd: a
    }), (t.watchSlidesProgress || t.centeredSlides && t.autoHeight) && i.updateSlidesProgress(e), r && !d && i.emit("reachBeginning toEdge"), a && !l && i.emit("reachEnd toEdge"), (d && !r || l && !a) && i.emit("fromEdge"), i.emit("progress", s)
}
...
function Xt(e = 0, i = this.params.speed, t = !0, n = !0, s) {
    ...
    if (n && e > l ? u = l : n && e < o ? u = o : u = e, r.updateProgress(u), a.cssMode) {
        ...
        if (i === 0) d[f ? "scrollLeft" : "scrollTop"] = -u;
            ...
            if (!r.support.smoothScroll) return ve({
                swiper: r,
                targetPosition: -u,
                side: f ? "left" : "top"
            }), !0;
...
function Kt(e = !0, i) {
    ...
    n.cssMode || (n.autoHeight && t.updateAutoHeight(), we({
        swiper: t,
        runCallbacks: e,
        direction: i,
        step: "Start"
...
function Jt(e = !0, i) {
    ...
    t.animating = !1, !n.cssMode && (t.setTransition(0), we({
        swiper: t,
        runCallbacks: e,
        direction: i,
        step: "End"
...
function Zt(e = 0, i = this.params.speed, t = !0, n, s) {
    ...
    if (d.cssMode) {
        ...
        if (i === 0) {
            ...
            T && (r.wrapperEl.style.scrollSnapType = "none", r._immediateVirtual = !0), p[v ? "scrollLeft" : "scrollTop"] = C, T && requestAnimationFrame(() => {
    ...
    return r.setTransition(i), r.setTranslate(y), r.updateActiveIndex(a), r.updateSlidesClasses(), r.emit("beforeTransitionStart", i, n), r.transitionStart(t, w), i === 0 ? r.transitionEnd(t, w) : r.animating || (r.animating = !0, r.onSlideToWrapperTransitionEnd || (r.onSlideToWrapperTransitionEnd = function(C) {
...
function si(e = this.params.speed, i = !0, t, n = .5) {
    const s = this;
    let r = s.activeIndex;
...
function ri() {
    ...
    if (i.loop) {
        ...
        r = parseInt(h(e.clickedSlide).attr("data-swiper-slide-index"), 10), i.centeredSlides ? s < e.loopedSlides - n / 2 || s > e.slides.length - e.loopedSlides + n / 2 ? (e.loopFix(), s = t.children(`.${i.slideClass}[data-swiper-slide-index="${r}"]:not(.${i.slideDuplicateClass})`).eq(0).index(), Q(() => {
            e.slideTo(s)
        })) : e.slideTo(s) : s > e.slides.length - n ? (e.loopFix(), s = t.children(`.${i.slideClass}[data-swiper-slide-index="${r}"]:not(.${i.slideDuplicateClass})`).eq(0).index(), Q(() => {
            e.slideTo(s)
        })) : e.slideTo(s)
    } else e.slideTo(s)
}
...
function mi(e) {
    ...
    if (Object.assign(s, {
            ...
            isScrolling: void 0,
            startMoving: void 0
        }), a.startX = m, a.startY = S, s.touchStartTime = R(), i.allowClick = !0, i.updateSize(), i.swipeDirection = void 0, r.threshold > 0 && (s.allowThresholdMove = !1), l.type !== "touchstart") {
        let w = !0;
...
function gi(e) {
    ...
    if (!t.allowTouchMove) {
        h(l.target).is(n.focusableElements) || (t.allowClick = !1), n.isTouched && (Object.assign(r, {
            startX: u,
            startY: f,
            currentX: u,
            currentY: f
...
const be = (e, i) => {
    ...
    if (!l.touch) r[u](s.start, e.onTouchStart, !1), t[u](s.move, e.onTouchMove, o), t[u](s.end, e.onTouchEnd, !1);
        ...
        const c = s.start === "touchstart" && l.passiveListener && n.passiveListeners ? {
            passive: !0,
            capture: !1
        } : !1;
        r[u](s.start, e.onTouchStart, c), r[u](s.move, e.onTouchMove, l.passiveListener ? {
            passive: !1,
            capture: o
        } : o), r[u](s.end, e.onTouchEnd, c), s.cancel && r[u](s.cancel, e.onTouchEnd, c)
...
function Ci() {
    ...
    const o = (d in a ? a[d] : void 0) || e.originalParams,
        ...
        f = oe(e, o),
        c = s.enabled;
    u && !f ? (r.removeClass(`${s.containerModifierClass}grid ${s.containerModifierClass}grid-column`), e.emitContainerClasses()) : !u && f && (r.addClass(`${s.containerModifierClass}grid`), (o.grid.fill && o.grid.fill === "column" || !o.grid.fill && s.grid.fill === "column") && r.addClass(`${s.containerModifierClass}grid-column`), e.emitContainerClasses()), ["navigation", "pagination", "scrollbar"].forEach(g => {
    ...
    }), c && !S ? e.disable() : !c && S && e.enable(), e.currentBreakpoint = d, e.emit("_beforeBreakpoint", o), m && t && (e.loopDestroy(), e.loopCreate(), e.updateSlides(), e.slideTo(i - n + e.loopedSlides, 0, !1)), e.emit("breakpoint", o)
}
...
let j = class A {
    constructor(...i) {
        ...
        const s = this;
        s.__swiper__ = !0, s.support = Se(), s.device = Ot({
            userAgent: n.userAgent
        }), s.browser = Lt(), s.eventsListeners = {}, s.eventsAnyListeners = [], s.modules = [...s.__modules__], n.modules && Array.isArray(n.modules) && s.modules.push(...n.modules);
        const r = {};
        s.modules.forEach(d => {
            d({
                swiper: s,
        ...
        const a = $({}, de, r);
        return s.params = $({}, a, K, n), s.originalParams = $({}, s.params), s.passedParams = $({}, n), s.params && s.params.on && Object.keys(s.params.on).forEach(d => {
    ...
    getSlideClasses(i) {
        const t = this;
        return t.destroyed ? "" : i.className.split(" ").filter(n => n.indexOf("swiper-slide") === 0 || n.indexOf(t.params.slideClass) === 0).join(" ")
    }
    emitSlidesClasses() {
        const i = this;
        if (!i.params._emitClasses || !i.el) return;
    ...
    slidesPerViewDynamic(i = "current", t = !1) {
        ...
        if (s.centeredSlides) {
            ...
            for (let f = o + 1; f < r.length; f += 1)(t ? a[f] + d[f] - a[o] < l : a[f] - a[o] < l) && (u += 1);
        else
            for (let f = o - 1; f >= 0; f -= 1) a[o] - a[f] < l && (u += 1);
        return u
    }
    update() {
        const i = this;
    ...
    changeDirection(i, t = !0) {
        ...
        return i || (i = s === "horizontal" ? "vertical" : "horizontal"), i === s || i !== "horizontal" && i !== "vertical" || (n.$el.removeClass(`${n.params.containerModifierClass}${s}`).addClass(`${n.params.containerModifierClass}${i}`), n.emitContainerClasses(), n.params.direction = i, n.slides.each(r => {
    ...
    mount(i) {
        ...
        if (a.length === 0 && t.params.createElements) {
            ...
            a = h(l), l.className = t.params.wrapperClass, n.append(l), n.children(`.${t.params.slideClass}`).each(o => {
                a.append(o)
            })
        }
        return Object.assign(t, {
            ...
            rtlTranslate: t.params.direction === "horizontal" && (i.dir.toLowerCase() === "rtl" || n.css("direction") === "rtl"),
    ...
    destroy(i = !0, t = !0) {
        ...
        return typeof n.params > "u" || n.destroyed || (n.emit("beforeDestroy"), n.initialized = !1, n.detachEvents(), s.loop && n.loopDestroy(), t && (n.removeClasses(), r.removeAttr("style"), a.removeAttr("style"), d && d.length && d.removeClass([s.slideVisibleClass, s.slideActiveClass, s.slideNextClass, s.slidePrevClass].join(" ")).removeAttr("style").removeAttr("data-swiper-slide-index")), n.emit("destroy"), Object.keys(n.eventsListeners).forEach(l => {
            n.off(l)
        }), i !== !1 && (n.$el[0].swiper = null, yt(n)), n.destroyed = !0), null
    }
...
function Ni(e, i, t) {
    ...
    function s(l, o, u) {
        return l.props || (l.props = {}), z(l.type, { ...l.props,
...
function Gi(e, i, t, n, s) {
    ...
    return Ee.filter(l => l[0] === "_").map(l => l.replace(/_/, "")).forEach(l => {
        if (l in e && l in i)
            if (G(e[l]) && G(i[l])) {
                const o = Object.keys(e[l]),
                    u = Object.keys(i[l]);
                o.length !== u.length ? a(l) : (o.forEach(f => {
                    e[l][f] !== i[l][f] && a(l)
                }), u.forEach(f => {
                    e[l][f] !== i[l][f] && a(l)
                }))
...
const Vi = e => {
    ...
    Fi = {
        ...
        setup(e, i) {
            ...
            const {
                tag: s,
                wrapperTag: r
            } = e, a = B("swiper"), d = B(null), l = B(!1), o = B(!1), u = B(null), f = B(null), c = B(null), p = {
                value: []
            }, m = {
                value: []
            }, S = B(null), g = B(null), y = B(null), w = B(null), {
                params: v,
                passedParams: C
            } = ue(e, !1);
            J(t, p, m), c.value = C, m.value = p.value;
            const T = () => {
                J(t, p, m), l.value = !0
            };
            if (v.onAny = function(O) {
                ...
                }), f.value = new j(v), f.value.loopCreate = () => {}, f.value.loopDestroy = () => {}, v.loop && (f.value.loopedSlides = Me(p.value, v)), f.value.virtual && f.value.params.virtual.enabled) {
            ...
            fe(() => {
                ...
                const {
                    passedParams: O
                } = ue(e, !1), x = Gi(O, c.value, p.value, m.value, D => D.props && D.props.key);
                c.value = O, (x.length || l.value) && f.value && !f.value.destroyed && ji({
                    swiper: f.value,
                    slides: p.value,
                    passedParams: O,
                    changedParams: x,
            ...
            function L(O) {
                return v.virtual ? Ri(f, O, d.value) : !v.loop || f.value && f.value.destroyed ? (O.forEach(x => {
            ...
            return () => {
                ...
                return z(s, {
                    ref: u,
                    class: Ce(a.value)
                }, [x["container-start"], z(r, {
                    class: "swiper-wrapper"
                }, [x["wrapper-start"], L(O), x["wrapper-end"]]), ye(e) && [z("div", {
                    ref: g,
    ...
    Wi = {
        ...
        setup(e, i) {
            ...
            return he("swiperSlide", l), () => z(e.tag, {
                class: Ce(`${a.value}`),
                ref: r,
