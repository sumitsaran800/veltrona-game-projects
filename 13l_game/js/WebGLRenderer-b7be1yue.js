import {D as R, E as d, b as F, J as B, y as p, z, a as ye, S as P, T as S, aA as Ce, ad as q, aB as Ne, A as g, R as V, X as y, ac as C, ae as O, N as Z, aC as J, aD as De, aE as Ie, aF as Q, aG as Ge, Y as Ue, Z as Fe, e as A} from "./init-B9ZVRwkz.js";
import {b as ee} from "./localUniformBit-BOGrcT1E.js";
import {e as Pe, G as Oe, c as Me, a as Le, U as we, B as te, b as N, d as He} from "./BufferResource-C1ksIqeS.js";
import {S as M} from "./Filter-5OKxlivX.js";
import {R as Ve, S as Xe, d as ke} from "./RenderTargetSystem-DCoiJPcG.js";
import "./index-BtSlvxrs.js";
...
class re {
    ...
    start(e, r, n) {
        ...
        s.shader.bind(n, i),
        i || (this._didUploadHash[n.uid] = !0),
        s.shader.updateUniformGroup(s.globalUniforms.uniformGroup),
        s.geometry.bind(r, n.glProgram)
    }
    execute(e, r) {
        const n = e.renderer;
...
var v = (t => (t[t.ELEMENT_ARRAY_BUFFER = 34963] = "ELEMENT_ARRAY_BUFFER",
...
class ne {
    ...
    bindBufferBase(e, r) {
        ...
        n.bindBufferBase(n.UNIFORM_BUFFER, r, e.buffer))
    }
    nextBindBase(e) {
        this._bindCallId++,
        this._minBaseLocation = 0,
    ...
    freeLocationForBufferBase(e) {
        ...
        n >= 2 ? -1 : (e._lastBindCallId = this._bindCallId,
    ...
    bindBufferRange(e, r, n, s) {
        ...
        r || (r = 0),
        this._boundBufferBases[r] = null,
        i.bindBufferRange(i.UNIFORM_BUFFER, r || 0, e.buffer, n * 256, s || 256)
    }
    updateBuffer(e) {
        const {_gl: r} = this
          , n = this.getGlBuffer(e);
        ...
        return s ? n.byteLength >= s.byteLength ? r.bufferSubData(n.type, 0, s, 0, e._updateSize / s.BYTES_PER_ELEMENT) : (n.byteLength = s.byteLength,
        r.bufferData(n.type, s, i)) : (n.byteLength = e.descriptor.size,
        r.bufferData(n.type, n.byteLength, i)),
        n
    }
    destroyAll(e=!1) {
...
const L = class se {
    ...
    init(e) {
        ...
        if (e.context && r && (p("Renderer created with both a context and multiview enabled. Disabling multiView as both cannot work together."),
        r = !1),
        r ? this.canvas = R.get().createCanvas(this._renderer.canvas.width, this._renderer.canvas.height) : this.canvas = this._renderer.view.canvas,
        e.context)
            this.initFromContext(e.context);
        else {
            const n = this._renderer.background.alpha < 1
    ...
    initFromContext(e) {
        this.gl = e,
        this.webGLVersion = e instanceof R.get().getWebGLRenderingContext() ? 1 : 2,
        this.getExtensions(),
    ...
    createContext(e, r) {
        let n;
        const s = this.canvas;
        if (e === 2 && (n = s.getContext("webgl2", r)),
        !n && (n = s.getContext("webgl", r),
        !n))
    ...
    validateContext(e) {
        ...
        const n = this.supports
          ...
          , i = this.extensions;
        n.uint32Indices = s || !!i.uint32ElementIndex,
        n.uniformBufferObject = s,
        n.vertexArrayObject = s || !!i.vertexArrayObject,
        n.srgbTextures = s || !!i.srgb,
        n.nonPowOf2wrapping = s,
        n.nonPowOf2mipmaps = s,
        n.msaa = s,
        n.uint32Indices || p("Provided WebGL context does not support 32 index buffer, large scenes may not render correctly")
    }
}
;
L.extension = {
...
t))(w || {})
  , l = (t => (t[t.UNSIGNED_BYTE = 5121] = "UNSIGNED_BYTE",
...
class ie {
    ...
    contextChange() {
        ...
        e.bindVertexArray = s => r.bindVertexArrayOES(s),
        e.deleteVertexArray = s => r.deleteVertexArrayOES(s));
        ...
        ,
        e.vertexAttribDivisor = (s, i) => n.vertexAttribDivisorANGLE(s, i)),
        this._activeGeometry = null,
        this._activeVao = null
    }
    bind(e, r) {
    ...
    onGeometryUnload(e, r=!1) {
        ...
        if (!r)
            for (const i in s)
                this._activeVao !== s[i] && this.resetState(),
                this.gl.deleteVertexArray(s[i])
    }
    destroyAll(e=!1) {
    ...
    activateVao(e, r) {
        ...
        for (const u in i) {
            ...
            if (h) {
                ...
                const b = z(c.format)
                  , E = $e(c.format);
                if (((o = h.format) == null ? void 0 : o.substring(1, 4)) === "int" ? n.vertexAttribIPointer(m, b.size, E, c.stride, c.offset) : n.vertexAttribPointer(m, b.size, E, b.normalised, c.stride, c.offset),
                c.instance)
                    if (this.hasInstance) {
    ...
    draw(e, r, n, s) {
        ...
        a.indexBuffer) {
            ...
            s !== 1 ? i.drawArraysInstanced(o, n || 0, r || a.getSize(), s) : i.drawArrays(o, n || 0, r || a.getSize());
        return this
    }
    unbind() {
...
const qe = new Ce({
  ...
  , H = class ae {
    ...
    init(e={}) {
        const {useBackBuffer: r, antialias: n} = {
            ...ae.defaultOptions,
            ...e
        };
        this.useBackBuffer = r,
        this._antialias = n,
        this._renderer.context.supports.msaa || (p("antialiasing, is not supported on when using the back buffer"),
        this._antialias = !1),
        this._state = M.for2d();
        const s = new ye({
            vertex: `
...
class ce {
    ...
    draw(e) {
        const r = this._renderer
          , {geometry: n, shader: s, state: i, skipSync: a, topology: o, size: u, start: c, instanceCount: _} = e;
        r.shader.bind(s, a),
        r.geometry.bind(n, r.shader._activeProgram),
        i && r.state.set(i),
        r.geometry.draw(o, u, c, _ ?? n.instanceCount)
    }
    destroy() {
        this._renderer = null
    }
...
class _e {
    ...
    setStencilMode(e, r) {
        ...
        s.stencilFunc(this._comparisonFuncMapping[i.stencilBack.compare], r, 255),
        s.stencilOp(s.KEEP, s.KEEP, this._stencilOpsMapping[i.stencilBack.passOp]))
    }
}
_e.extension = {
    type: [d.WebGLSystem],
...
class rt {
    ...
    copyToTexture(e, r, n, s, i) {
        ...
        o.texture.bind(r, 0),
        c.copyTexSubImage2D(c.TEXTURE_2D, 0, i.x, i.y, n.x, n.y, s.width, s.height),
        r
    }
    startRenderPass(e, r=!0, n, s, i=0, a=0) {
        ...
        let _ = s.y;
        e.isRoot && (_ = u.pixelHeight - s.height - s.y),
        e.colorTextures.forEach(m => {
            this._renderer.texture.unbind(m)
        }
        );
        const f = this._renderer.gl;
        f.bindFramebuffer(f.FRAMEBUFFER, c.framebuffer),
        !e.isRoot && (c._attachedMipLevel !== i || c._attachedLayer !== a) && (e.colorTextures.forEach( (m, b) => {
            ...
            if (E.target === f.TEXTURE_2D) {
                ...
                f.framebufferTexture2D(f.FRAMEBUFFER, f.COLOR_ATTACHMENT0 + b, f.TEXTURE_2D, E.texture, i)
            } else if (E.target === f.TEXTURE_2D_ARRAY) {
                if (this._renderer.context.webGLVersion < 2)
                    throw new Error("[RenderTargetSystem] Rendering to 2D array textures requires WebGL2.");
                f.framebufferTextureLayer(f.FRAMEBUFFER, f.COLOR_ATTACHMENT0 + b, E.texture, i, a)
            } else if (E.target === f.TEXTURE_CUBE_MAP) {
                if (a < 0 || a > 5)
                    throw new Error("[RenderTargetSystem] Cube map layer must be between 0 and 5.");
                f.framebufferTexture2D(f.FRAMEBUFFER, f.COLOR_ATTACHMENT0 + b, f.TEXTURE_CUBE_MAP_POSITIVE_X + a, E.texture, i)
            } else
                throw new Error("[RenderTargetSystem] Unsupported texture target for render-to-layer in WebGL.")
        }
        ),
        c._attachedMipLevel = i,
        c._attachedLayer = a),
        e.colorTextures.length > 1 && this._setDrawBuffers(e, f);
        const h = this._viewPortCache;
        (h.x !== s.x || h.y !== _ || h.width !== s.width || h.height !== s.height) && (h.x = s.x,
        h.y = _,
        h.width = s.width,
        h.height = s.height,
        f.viewport(s.x, _, s.width, s.height)),
    ...
    finishRenderPass(e) {
        ...
        if (!n.msaa)
            return;
        const s = this._renderer.gl;
        s.bindFramebuffer(s.FRAMEBUFFER, n.resolveTargetFramebuffer),
        s.bindFramebuffer(s.READ_FRAMEBUFFER, n.framebuffer),
        s.blitFramebuffer(0, 0, n.width, n.height, 0, 0, n.width, n.height, s.COLOR_BUFFER_BIT, s.NEAREST),
        s.bindFramebuffer(s.FRAMEBUFFER, n.framebuffer)
    }
    initGpuRenderTarget(e) {
        const n = this._renderer.gl
          , s = new Je;
        return s._attachedMipLevel = 0,
        s._attachedLayer = 0,
        e.colorTexture instanceof y ? (this._renderer.context.ensureCanvasSize(e.colorTexture.resource),
        s.framebuffer = null,
    ...
    clear(e, r, n, s, i=0, a=0) {
        ...
        if (r & C.COLOR) {
            ...
            const c = this._clearColorCache
              , _ = n;
            (c[0] !== _[0] || c[1] !== _[1] || c[2] !== _[2] || c[3] !== _[3]) && (c[0] = _[0],
            c[1] = _[1],
            c[2] = _[2],
            c[3] = _[3],
            u.clearColor(_[0], _[1], _[2], _[3]))
        }
        u.clear(r)
    }
    resizeGpuRenderTarget(e) {
        ...
        (e.stencil || e.depth) && this._resizeStencil(n)
    }
    _initColor(e, r) {
        ...
        e.colorTextures.forEach( (o, u) => {
            const c = o.source;
            c.antialias && (n.context.supports.msaa ? r.msaa = !0 : p("[RenderTexture] Antialiasing on textures is not supported in WebGL1")),
            n.texture.bindSource(c, 0);
            const _ = n.texture.getGlSource(c)
              , f = _.texture;
            if (_.target === s.TEXTURE_2D)
                s.framebufferTexture2D(s.FRAMEBUFFER, s.COLOR_ATTACHMENT0 + u, s.TEXTURE_2D, f, 0);
                ...
                s.framebufferTextureLayer(s.FRAMEBUFFER, s.COLOR_ATTACHMENT0 + u, f, 0, 0)
            } else if (_.target === s.TEXTURE_CUBE_MAP)
                s.framebufferTexture2D(s.FRAMEBUFFER, s.COLOR_ATTACHMENT0 + u, s.TEXTURE_CUBE_MAP_POSITIVE_X, f, 0);
            else
    ...
    _resizeColor(e, r) {
        ...
        if (r.width = n.pixelWidth,
        r.height = n.pixelHeight,
        r._attachedMipLevel = 0,
        r._attachedLayer = 0,
        e.colorTextures.forEach( (s, i) => {
        ...
        r.msaa) {
            ...
            e.colorTextures.forEach( (o, u) => {
                ...
                const f = s.texture.getGlSource(c).internalFormat
                  , h = r.msaaRenderBuffer[u];
                i.bindRenderbuffer(i.RENDERBUFFER, h),
                i.renderbufferStorageMultisample(i.RENDERBUFFER, 4, f, c.pixelWidth, c.pixelHeight),
                i.framebufferRenderbuffer(i.FRAMEBUFFER, i.COLOR_ATTACHMENT0 + u, i.RENDERBUFFER, h)
            }
            )
        }
    }
    _initStencil(e) {
        ...
        r.framebufferRenderbuffer(r.FRAMEBUFFER, r.DEPTH_STENCIL_ATTACHMENT, r.RENDERBUFFER, n),
    ...
    _setDrawBuffers(e, r) {
        const n = e.colorTextures.length
          , s = this._drawBuffersCache[n];
    ...
    for (const u in t.groups) {
        ...
        for (const _ in c.resources) {
            ...
            if (f instanceof O)
                ...
                const h = t._uniformBindMap[u][_]
                  , m = a.uniformData[h];
                m && (s || (s = !0,
                n.push(`
                        var tS = r.texture;
                        `)),
                e._gl.uniform1i(m.location, i),
                r.push(`
...
function ct(t, e) {
    ...
    for (let s = 0; s < n; s++) {
        const i = e.getActiveUniformBlockName(t, s)
          , a = e.getUniformBlockIndex(t, i)
          , o = e.getActiveUniformBlockParameter(t, s, e.UNIFORM_BLOCK_DATA_SIZE);
        r[i] = {
            name: i,
            index: a,
            size: o
...
`).map( (c, _) => `${_}: ${c}`)
      , s = t.getShaderInfoLog(e).split(`
`)
      , i = {}
      , a = s.map(c => parseFloat(c.replace(/^ERROR\: 0\:([\d]+)\:.*$/, "$1"))).filter(c => c && !i[c] ? (i[c] = !0,
    !0) : !1)
      , o = [""];
    a.forEach(c => {
        r[c - 1] = `%c${r[c - 1]}%c`,
...
function _t(t, e, r, n) {
    t.getProgramParameter(e, t.LINK_STATUS) || (t.getShaderParameter(r, t.COMPILE_STATUS) || j(t, r),
    t.getShaderParameter(n, t.COMPILE_STATUS) || j(t, n),
    t.getProgramInfoLog(e))
}
function ft(t, e) {
    const r = k(t, t.VERTEX_SHADER, e.vertex)
      , n = k(t, t.FRAGMENT_SHADER, e.fragment)
      , s = t.createProgram();
    t.attachShader(s, r),
    t.attachShader(s, n);
    const i = e.transformFeedbackVaryings;
    i && (typeof t.transformFeedbackVaryings != "function" ? p("TransformFeedback is not supported but TransformFeedbackVaryings are given.") : t.transformFeedbackVaryings(s, i.names, i.bufferMode === "separate" ? t.SEPARATE_ATTRIBS : t.INTERLEAVED_ATTRIBS)),
    t.linkProgram(s),
    t.getProgramParameter(s, t.LINK_STATUS) || _t(t, s, r, n),
    e._attributeData = ot(s, t, !/^[ \t]*#[ \t]*version[ \t]+300[ \t]+es[ \t]*$/m.test(e.vertex)),
    e._uniformData = ut(s, t),
    e._uniformBlockData = ct(s, t),
    t.deleteShader(r),
    t.deleteShader(n);
    const a = {};
...
class Ee {
    ...
    _createProgramData(e) {
        const r = e._key;
        return this._programDataHash[r] = ft(this._gl, e),
...
function dt(t, e) {
    ...
    for (const n in t.uniforms) {
        if (!e[n]) {
            t.uniforms[n]instanceof O ? t.uniforms[n].ubo ? r.push(`
                        renderer.shader.bindUniformBlock(uv.${n}, "${n}");
                    `) : r.push(`
                        renderer.shader.updateUniformGroup(uv.${n});
                    `) : t.uniforms[n]instanceof te && r.push(`
...
class be {
    ...
    updateUniformGroup(e, r, n) {
        ...
        this._getUniformSyncFunction(e, r)(s.uniformData, e.uniforms, this._renderer, n))
    }
    ...
    _createUniformSyncFunction(e, r) {
        const n = this._uniformGroupSyncHash[e._signature] || (this._uniformGroupSyncHash[e._signature] = {})
          , s = this._getSignature(e, r._uniformData, "u");
        return this._cache[s] || (this._cache[s] = this._generateUniformsSync(e, r._uniformData)),
        n[r._key] = this._cache[s],
        n[r._key]
    }
...
function mt(t) {
    ...
    !(t instanceof R.get().getWebGLRenderingContext()))
        ...
        n && (e.min = [t.ONE, t.ONE, t.ONE, t.ONE, n.MIN_EXT, n.MIN_EXT],
        e.max = [t.ONE, t.ONE, t.ONE, t.ONE, n.MAX_EXT, n.MAX_EXT])
    }
    return e
}
const Et = 0
  ...
  , pe = class U {
    constructor(e) {
        ...
        this._blendEq = !1,
        this.map = [],
        this.map[Et] = this.setBlend,
        this.map[bt] = this.setOffset,
        this.map[pt] = this.setCullFace,
        this.map[St] = this.setDepthTest,
        this.map[Rt] = this.setFrontFace,
        this.map[gt] = this.setDepthMask,
        this.checks = [],
        this.defaultState = M.for2d(),
        e.renderTarget.onRenderTargetChange.add(this)
    }
    onRenderTargetChange(e) {
    ...
    set(e) {
        ...
        this.stateId !== e.data) {
            let r = this.stateId ^ e.data
              , n = 0;
            for (; r; )
                r & 1 && this.map[n].call(this, !!(e.data & 1 << n)),
                r >>= 1,
                n++;
            this.stateId = e.data
        }
    ...
    setBlend(e) {
        this._updateCheck(U._checkBlendMode, e),
        this.gl[e ? "enable" : "disable"](this.gl.BLEND)
    }
    setOffset(e) {
        this._updateCheck(U._checkPolygonOffset, e),
    ...
    setBlendMode(e) {
        ...
        const r = this.blendModesMap[e]
          , n = this.gl;
        r.length === 2 ? n.blendFunc(r[0], r[1]) : n.blendFuncSeparate(r[0], r[1], r[2], r[3]),
        r.length === 6 ? (this._blendEq = !0,
        n.blendEquationSeparate(r[4], r[5])) : this._blendEq && (this._blendEq = !1,
...
const vt = {
    ...
    upload(t, e, r, n, s, i=!1) {
        const a = s || e.target;
        !i && e.width === t.width && e.height === t.height ? r.texSubImage2D(a, 0, 0, 0, t.width, t.height, e.format, e.type, t.resource) : r.texImage2D(a, 0, e.internalFormat, t.width, t.height, 0, e.format, e.type, t.resource),
        e.width = t.width,
        e.height = t.height
    }
}
  ...
  , Bt = {
    ...
    upload(t, e, r, n, s, i) {
        ...
        for (let _ = 0; _ < t.resource.length; _++) {
            ...
            c ? r.compressedTexImage2D(a, _, e.internalFormat, o, u, 0, f) : r.texImage2D(a, _, e.internalFormat, o, u, 0, e.format, e.type, f),
            o = Math.max(o >> 1, 1),
            u = Math.max(u >> 1, 1)
        }
    }
    ...
    return {
        ...
        upload(e, r, n, s) {
            ...
            for (let a = 0; a < K.length; a++) {
                const o = K[a]
                  , u = i[o];
                (t[u.uploadMethodId] || t.image).upload(u, r, n, s, w.TEXTURE_CUBE_MAP_POSITIVE_X + a, (r._layerInitMask & 1 << a) === 0),
                r._layerInitMask |= 1 << a
            }
            r.width = e.pixelWidth,
            r.height = e.pixelHeight
        }
    }
}
const Se = {
    ...
    upload(t, e, r, n, s, i=!1) {
        const a = s || e.target
          ...
          , _ = t.resourceHeight
          , f = n === 2
          , h = i || e.width !== o || e.height !== u
          , m = c >= o && _ >= u
          , b = t.resource;
        (f ? Ct : Nt)(r, a, e, o, u, c, _, b, h, m),
        e.width = o,
        e.height = u
    }
};
function Ct(t, e, r, n, s, i, a, o, u, c) {
    if (!c) {
        u && t.texImage2D(e, 0, r.internalFormat, n, s, 0, r.format, r.type, null),
        t.texSubImage2D(e, 0, 0, 0, i, a, r.format, r.type, o);
        return
    }
    if (!u) {
...
function Y(t, e, r, n, s, i, a, o) {
    ...
    if (!o || t.addressModeU !== "repeat" || t.addressModeV !== "repeat" || t.addressModeW !== "repeat") {
        const c = I[a ? "clamp-to-edge" : t.addressModeU]
          , _ = I[a ? "clamp-to-edge" : t.addressModeV]
          , f = I[a ? "clamp-to-edge" : t.addressModeW];
        e[s](u, e.TEXTURE_WRAP_S, c),
        e[s](u, e.TEXTURE_WRAP_T, _),
        e.TEXTURE_WRAP_R && e[s](u, e.TEXTURE_WRAP_R, f)
    }
    if ((!o || t.magFilter !== "linear") && e[s](u, e.TEXTURE_MAG_FILTER, $[t.magFilter]),
    r) {
...
class Re {
    ...
    contextChange(e) {
        this._gl = e,
        this._mapFormatToInternalFormat || (this._mapFormatToInternalFormat = Pt(e, this._renderer.context.extensions),
        this._mapFormatToType = Ot(e),
        this._mapFormatToFormat = Ft(e),
        this._mapViewDimensionToGlTarget = Mt(e)),
    ...
    bind(e, r=0) {
        const n = e.source;
        e ? (this.bindSource(n, r),
        this._useSeparateSamplers && this._bindSampler(n.style, r)) : (this.bindSource(null, r),
    ...
    _bindSampler(e, r=0) {
        ...
        if (!e) {
            ...
            n.bindSampler(r, null);
            return
        }
        const s = this._getGlSampler(e);
        this._boundSamplers[r] !== s && (this._boundSamplers[r] = s,
        n.bindSampler(r, s))
    }
    unbind(e) {
        const r = e.source
    ...
    updateStyle(e, r) {
        ...
        Y(e.style, n, e.mipLevelCount > 1, this._renderer.context.extensions.anisotropicFiltering, "texParameteri", s.target, !this._renderer.context.supports.nonPowOf2wrapping && !e.isPowerOfTwo, r)
    }
    ...
    onSourceUpdate(e) {
        ...
        if (this._premultiplyAlpha !== s && (this._premultiplyAlpha = s,
        r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL, s)),
    ...
    _initEmptyTexture2D(e, r) {
        ...
        let s = Math.max(r.pixelWidth >> 1, 1)
          , i = Math.max(r.pixelHeight >> 1, 1);
        for (let a = 1; a < r.mipLevelCount; a++)
            n.texImage2D(n.TEXTURE_2D, a, e.internalFormat, s, i, 0, e.format, e.type, null),
            s = Math.max(s >> 1, 1),
            i = Math.max(i >> 1, 1)
    }
    _initEmptyTexture2DArray(e, r) {
        ...
        const n = this._gl
          , s = Math.max(r.arrayLayerCount | 0, 1);
        ...
        let i = Math.max(r.pixelWidth >> 1, 1)
          , a = Math.max(r.pixelHeight >> 1, 1);
        for (let o = 1; o < r.mipLevelCount; o++)
            n.texImage3D(n.TEXTURE_2D_ARRAY, o, e.internalFormat, i, a, s, 0, e.format, e.type, null),
            i = Math.max(i >> 1, 1),
            a = Math.max(a >> 1, 1)
    }
    _initEmptyTextureCube(e, r) {
        const n = this._gl
          , s = 6;
        for (let o = 0; o < s; o++)
            n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X + o, 0, e.internalFormat, r.pixelWidth, r.pixelHeight, 0, e.format, e.type, null);
        let i = Math.max(r.pixelWidth >> 1, 1)
          , a = Math.max(r.pixelHeight >> 1, 1);
        for (let o = 1; o < r.mipLevelCount; o++) {
            for (let u = 0; u < s; u++)
                n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X + u, o, e.internalFormat, i, a, 0, e.format, e.type, null);
            i = Math.max(i >> 1, 1),
            a = Math.max(a >> 1, 1)
        }
    }
    _applyMipRange(e, r) {
        if (this._renderer.context.webGLVersion !== 2 || r.mipLevelCount <= 1)
            return;
        const n = this._gl
          , s = Math.max((r.mipLevelCount | 0) - 1, 0);
        n.texParameteri(e.target, n.TEXTURE_BASE_LEVEL, 0),
        n.texParameteri(e.target, n.TEXTURE_MAX_LEVEL, s)
    }
    _initSampler(e) {
        const r = this._gl
          , n = this._gl.createSampler();
        return this._glSamplers[e._resourceId] = n,
        Y(e, r, this._boundTextures[this._activeTextureLocation].mipLevelCount > 1, this._renderer.context.extensions.anisotropicFiltering, "samplerParameteri", n, !1, !0),
    ...
    generateCanvas(e) {
        const {pixels: r, width: n, height: s} = this.getPixels(e)
          , i = R.get().createCanvas();
        i.width = n,
        i.height = s;
    ...
    getPixels(e) {
        const r = e.source.resolution
          , n = e.frame
          , s = Math.max(Math.round(n.width * r), 1)
          , i = Math.max(Math.round(n.height * r), 1)
          , a = new Uint8Array(Lt * s * i)
          , o = this._renderer
        ...
        _.readPixels(Math.round(n.x * r), Math.round(n.y * r), s, i, _.RGBA, _.UNSIGNED_BYTE, a),
        {
    ...
    resetState() {
        this._activeTextureLocation = -1,
        this._boundTextures.fill(S.EMPTY.source),
        this._boundSamplers = Object.create(null);
        const e = this._gl;
        this._premultiplyAlpha = !1,
...
class ge {
    ...
    execute(e, r) {
        const n = r.context
          , s = n.customShader || this.shader
          , i = e.renderer
          , a = i.graphicsContext
          , {batcher: o, instructions: u} = a.getContextRenderData(n);
        s.groups[0] = i.globalUniforms.bindGroup,
        i.state.set(e.state),
        i.shader.bind(s),
        i.geometry.bind(o.geometry, s.glProgram);
...
class Te {
    ...
    execute(e, r) {
        ...
        if (s) {
            ...
            s.resources.textureUniforms.uniforms.uTextureMatrix = i.textureMatrix.mapCoord
        }
        s.groups[100] = n.globalUniforms.bindGroup,
...
const wt = [...Xe, he, Ze, Ke, ue, ne, Re, le, ie, be, Ee, ce, Tt, _e, oe]
  , Ht = [...ke]
  , Vt = [re, Te, ge]
  , xe = []
  , ve = []
